    ...
    <section className="w-full py-12 md:py-24 lg:py-32 xl:py-45 -mt-16">
      <div className="container grid items-center gap-6 px-2 md:px-6 lg:grid-cols-[1fr_550px] lg:gap-12 xl:grid-cols-[1fr_650px]">
        <div className="space-y-4">
          <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl mt-20 xl:text-6xl/none">
          ...
          <div className="flex flex-col gap-2 min-[400px]:flex-row">
            ...
            <a
              className="inline-flex h-10 items-center justify-center rounded-md border border-gray-200 border-gray-200  bg-[#701878] px-8 text-sm font-medium shadow-sm 
